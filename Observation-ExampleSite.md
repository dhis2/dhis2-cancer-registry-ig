# Example Site - DHIS2 Cancer Registry Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example Site**

## Example Observation: Example Site

Profile: [Site](StructureDefinition-cr-site-observation.md)
...
```json
{
  ...
  "id" : "ExampleSite",
  "meta" : {
    "profile" : ["https://dhis2.org/fhir/cancer-registry/StructureDefinition/cr-site-observation"]
  },
  "status" : "final",
  "code" : {
    "coding" : [{
