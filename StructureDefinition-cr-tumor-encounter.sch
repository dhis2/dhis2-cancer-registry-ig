...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      <sch:assert test="count(f:extension[@url = 'https://dhis2.org/fhir/cancer-registry/StructureDefinition/cr-rare']) &lt;= 1">extension with URL = 'https://dhis2.org/fhir/cancer-registry/StructureDefinition/cr-rare': maximum cardinality of 'extension' is 1</sch:assert>
