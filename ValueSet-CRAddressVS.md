# CR - Address value set - DHIS2 Cancer Registry Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CR - Address value set**

## ValueSet: CR - Address value set 

| | |
| :--- | :--- |
| *Official URL*:https://dhis2.org/fhir/cancer-registry/ValueSet/CRAddressVS | *Version*:0.1.0 |
| Active as of 2026-04-14 | *Computable Name*:CRAddressVS |

 
Value set of address codes containing placeholder values that must be customised prior to implementation to reflect the administrative geography of the country or region. 
