# CR - Basis diagnosis value set - DHIS2 Cancer Registry Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CR - Basis diagnosis value set**

## ValueSet: CR - Basis diagnosis value set 

| | |
| :--- | :--- |
| *Official URL*:https://dhis2.org/fhir/cancer-registry/ValueSet/CRBasisDiagnosisVS | *Version*:0.1.0 |
| Active as of 2026-04-14 | *Computable Name*:CRBasisDiagnosisVS |

 
Value set of basis of diagnosis codes aligned with the CanReg5 basis dictionary. Codes 0-4 are non-microscopically confirmed, codes 5-8 are microscopically confirmed, and code 9 is unknown. 
