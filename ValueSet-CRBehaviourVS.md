# CR - Behaviour value set - DHIS2 Cancer Registry Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CR - Behaviour value set**

## ValueSet: CR - Behaviour value set 

| | |
| :--- | :--- |
| *Official URL*:https://dhis2.org/fhir/cancer-registry/ValueSet/CRBehaviourVS | *Version*:0.1.0 |
| Active as of 2026-04-14 | *Computable Name*:CRBehaviourVS |

 
Value set of tumour behaviour codes aligned with the CanReg5 ICD-O-3.2 behaviour dictionary, used in the Tumor stage to classify the biological behaviour of the neoplasm. 
