# CR - Morphology Group value set - DHIS2 Cancer Registry Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CR - Morphology Group value set**

## ValueSet: CR - Morphology Group value set 

| | |
| :--- | :--- |
| *Official URL*:https://dhis2.org/fhir/cancer-registry/ValueSet/CRMorphologyGroupVS | *Version*:0.1.0 |
| Active as of 2026-04-14 | *Computable Name*:CRMorphologyGroupVS |

 
Value set of morphology group codes used in the Multiple Primary Tester data quality check, derived from the CanReg5 DefaultMultiplePrimaryTester mapping logic. 
