# CR - Morphology result value set - DHIS2 Cancer Registry Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CR - Morphology result value set**

## ValueSet: CR - Morphology result value set 

| | |
| :--- | :--- |
| *Official URL*:https://dhis2.org/fhir/cancer-registry/ValueSet/CRMorphologyResultVS | *Version*:0.1.0 |
| Active as of 2026-04-10 | *Computable Name*:CRMorphologyResultVS |

 
Value set of intermediate morphology evaluation result codes used in the Multiple Primary Tester check to determine whether to proceed to topography evaluation. 
