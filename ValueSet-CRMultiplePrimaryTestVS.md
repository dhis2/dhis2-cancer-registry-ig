# CR - Multiple primary test value set - DHIS2 Cancer Registry Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CR - Multiple primary test value set**

## ValueSet: CR - Multiple primary test value set 

| | |
| :--- | :--- |
| *Official URL*:https://dhis2.org/fhir/cancer-registry/ValueSet/CRMultiplePrimaryTestVS | *Version*:0.1.0 |
| Active as of 2026-04-10 | *Computable Name*:CRMultiplePrimaryTestVS |

 
Value set of result codes for the Multiple Primary Tester data quality check, determining whether tumours are duplicate registrations, distinct multiple primaries, or have unknown topography. 
