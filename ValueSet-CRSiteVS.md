# CR - Site value set - DHIS2 Cancer Registry Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CR - Site value set**

## ValueSet: CR - Site value set 

| | |
| :--- | :--- |
| *Official URL*:https://dhis2.org/fhir/cancer-registry/ValueSet/CRSiteVS | *Version*:0.1.0 |
| Active as of 2026-04-14 | *Computable Name*:CRSiteVS |

 
Value set of anatomical site codes used to filter topography values in a dependent dropdown list for simplified data entry. 
