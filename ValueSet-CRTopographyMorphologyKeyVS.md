# CR - Topography Morphology key value set - DHIS2 Cancer Registry Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CR - Topography Morphology key value set**

## ValueSet: CR - Topography Morphology key value set 

| | |
| :--- | :--- |
| *Official URL*:https://dhis2.org/fhir/cancer-registry/ValueSet/CRTopographyMorphologyKeyVS | *Version*:0.1.0 |
| Active as of 2026-04-14 | *Computable Name*:CRTopographyMorphologyKeyVS |

 
Value set of keys used in the Topography-Morphology data quality check. NA (*) means accepted with any topography; Plus (+) means checked against the MUST list; Minus (-) means checked against the MUST-NOT list. 
