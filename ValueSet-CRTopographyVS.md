# CR - Topography value set - DHIS2 Cancer Registry Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CR - Topography value set**

## ValueSet: CR - Topography value set 

| | |
| :--- | :--- |
| *Official URL*:https://dhis2.org/fhir/cancer-registry/ValueSet/CRTopographyVS | *Version*:0.1.0 |
| Active as of 2026-04-14 | *Computable Name*:CRTopographyVS |

 
Value set of ICD-O-3 topography codes mapped from the CanReg5 topography dictionary, representing anatomical sites of tumour origin. 
