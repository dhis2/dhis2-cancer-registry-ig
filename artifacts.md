...
| | |
| :--- | :--- |
| [Transform: Cancer Registry Enrollment to EpisodeOfCare](StructureMap-CancerRegistryToEpisode.md) | Maps DHIS2 Cancer Registry enrollment to a FHIR EpisodeOfCare resource. |
| [Transform: Cancer Registry Enrollment to Patient](StructureMap-CancerRegistryToPatient.md) | Maps DHIS2 Cancer Registry enrollment TEAs to a FHIR Patient resource. |
| [Transform: Follow-up Stage to Encounter + Observations](StructureMap-FollowUpToEncounterAndObservations.md) | Maps a DHIS2 Follow-up stage event to a FHIR Encounter and Observation bundle. |
| [Transform: Source Stage to Encounter + Observations](StructureMap-SourceToEncounterAndObservations.md) | Maps a DHIS2 Source stage event to a FHIR Encounter and Observation bundle. |
| [Transform: Tumor Stage to Encounter + Observations](StructureMap-TumorToEncounterAndObservations.md) | Maps a DHIS2 Tumor stage event to a FHIR Encounter and Observation bundle. |
