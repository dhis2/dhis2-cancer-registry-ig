...
* identifier[regno] ^short = "Patient registration number (REGNO)"
* identifier[regno] ^definition = "The unique patient registration number assigned by the cancer registry, following the convention CURRENT_DATE(yyyy)+SEQUENTIAL(####). Must be at least 8 characters."
* name 1..* MS
* name.family 1..1 MS
...
* gender 1..1 MS
* gender ^short = "Administrative sex of the patient (mapped from sex codes 1=male, 2=female, 9=unknown)"
* birthDate 1..1 MS
