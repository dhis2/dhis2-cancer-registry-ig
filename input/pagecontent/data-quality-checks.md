...
- **MUST list:** combinations where a family _must_ be associated with specific topography sites. If not found, the combination is rare.
- **MUST-NOT list:** combinations where a family _must not_ be associated with specific topography sites. If found, the combination is rare.
...
2. **Topography evaluation** — performed only when the morphology result is undecided; compares current and previous topography groups.
...
| Check                             | Variables                          | Result                         | CanReg5 Source                                                                                                                                                   |
| --------------------------------- | ---------------------------------- | ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
