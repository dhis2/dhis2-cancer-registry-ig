# System Design - DHIS2 Cancer Registry Implementation Guide v0.1.0
...
The Tumor stage is the central component of the tracker program. It captures all key clinical and epidemiological information and is where the full set of [data quality checks](data-quality-checks.md) is applied.
